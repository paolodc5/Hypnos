...
from services.auth_service import authenticate_patient
...
class LoginWindow(ctk.CTk):
    def __init__(self):
        ...
        self.username_entry = ctk.CTkEntry(self, placeholder_text="Enter your surname", width=200)
    ...
    def login_callback(self):
        ...
        print(f"Attempting to login with surname: {name} and password: {password}")
...
if __name__ == "__main__":
    ...
    # credentials = { Surname: "Darius Barker", Password: "12345" }